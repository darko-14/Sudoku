...
def check_row():
    row_1 = [ board[11], board[12], board[13], board[14], board[15], board[16], board[17], board[18], board[19] ]
    row_2 = [ board[21], board[22], board[23], board[24], board[25], board[26], board[27], board[28], board[29] ]
    row_3 = [ board[31], board[32], board[33], board[34], board[35], board[36], board[37], board[38], board[39] ]
    row_4 = [ board[41], board[42], board[43], board[44], board[45], board[46], board[47], board[48], board[49] ]
    row_5 = [ board[51], board[52], board[53], board[54], board[55], board[56], board[57], board[58], board[59] ]
    row_6 = [ board[61], board[62], board[63], board[64], board[65], board[66], board[67], board[68], board[69] ]
    row_9 = [ board[91], board[92], board[93], board[94], board[95], board[96], board[97], board[98], board[99] ]
    row_7 = [ board[71], board[72], board[73], board[74], board[75], board[76], board[77], board[78], board[79] ]
    row_8 = [ board[81], board[82], board[83], board[84], board[85], board[86], board[87], board[88], board[89] ]
...
def check_column():
    column_1 = [ board[11], board[21], board[31], board[41], board[51], board[61], board[71], board[81], board[91] ]
    column_2 = [ board[12], board[22], board[32], board[42], board[52], board[62], board[72], board[82], board[92] ]
    column_3 = [ board[13], board[23], board[33], board[43], board[53], board[63], board[73], board[83], board[93] ]
    column_4 = [ board[14], board[24], board[34], board[44], board[54], board[64], board[74], board[84], board[94] ]
    column_5 = [ board[15], board[25], board[35], board[45], board[55], board[65], board[75], board[85], board[95] ]
    column_6 = [ board[16], board[26], board[36], board[46], board[56], board[66], board[76], board[86], board[96] ]
    column_7 = [ board[17], board[27], board[37], board[47], board[57], board[67], board[77], board[87], board[97] ]
    column_8 = [ board[18], board[28], board[38], board[48], board[58], board[68], board[78], board[88], board[98] ]
    column_9 = [ board[19], board[29], board[39], board[49], board[59], board[69], board[79], board[89], board[99] ]
...
def check_if_table_is_full():
    ...
    if "-" not in board.values():
        ...
        time = end - start
        print("Finished in: ", round(time, 1), " seconds.")
        print()
...
def generate_random_numbers():
    ran = random.sample(list(board), 80)
